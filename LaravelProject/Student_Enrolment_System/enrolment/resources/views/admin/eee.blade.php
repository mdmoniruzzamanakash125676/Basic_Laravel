                  ...
                  <table id="order-listing" class="table table-striped" style="width:100%;">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td>
                          <a href="{{URL::to('/eee_view/'.$v_student->student_id)}}">
                          <button class="btn btn-outline-primary">View</button>
                          </a> 
                            <a href="{{URL::to('/eee_delete/'.$v_student->student_id)}}" data-confirm="Are you sure to delete this item?" class="delete"><button class="btn btn-outline-danger">Delete</button></a>                          </td>
                      </tr>
                      @endforeach
