              ...
              <div class="row">
                <div class="col-12">
                  <table id="order-listing" class="table table-striped" style="width:100%;">
                    ...
                    <tbody>
                        @foreach($mme_student_info as $v_student)
                      <tr>
                          ...
                          <td>
                          <a href="{{URL::to('/mme_view/'.$v_student->student_id)}}">
                          <button class="btn btn-outline-primary">View</button>
                          </a> 
                            <a href="{{URL::to('/mme_delete/'.$v_student->student_id)}}" data-confirm="Are you sure to delete this item?" class="delete"><button class="btn btn-outline-danger">Delete</button></a>                          </td>
                      </tr>
                      @endforeach
