          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="layoutsSubmenu">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{asset('pages/layout/boxed-layout.html')}}">Tusion Fee</a>
                  </li>
                  <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="sidebar_layouts">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{asset('pages/layout/compact-menu.html')}}">CSE</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{asset('pages/layout/sidebar-collapsed.html')}}">ME</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{asset('pages/layout/sidebar-hidden.html')}}">EEE</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{asset('pages/layout/sidebar-hidden-overlay.html')}}">Civil</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{asset('pages/layout/sidebar-fixed.html')}}">MME</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{asset('pages/layout/sidebar-fixed.html')}}">Food</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{asset('pages/layout/sidebar-fixed.html')}}">BA</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{asset('pages/layout/sidebar-fixed.html')}}">MA</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="advancedSubmenu">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{asset('pages/forms/form-addons.html')}}">Form addons</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{asset('pages/forms/form-picker.html')}}">Form Picker</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{asset('pages/forms/bt-select-splitter.html')}}">Splitter</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{asset('pages/forms/icheck.html')}}">Icheck</a>
                  </li>
                </ul>
              </div>
            </li>
